! function(a) {
    ...
    var j = {
        ...
        k = a.TextEncoder,
        l = a.TextDecoder;
    if (j.PixelData) var m = document.createElement("canvas").getContext("2d"),
        n = function(a, b) {
    ...
    var p = e.prototype = {
        ...
        _setBytes: function(a, b, e) {
            var f = b.length;
            if (0 !== f) {
                if (e = d(e, this._littleEndian), a = d(a, this._offset), this._checkBounds(a, f), !e && f > 1 && (b = c(b, !0).reverse()), a += this.byteOffset, this._isArrayBuffer) new Uint8Array(this.buffer, a, f).set(b);
                else
                    for (var g = 0; f > g; g++) this.buffer[a + g] = b[g];
        ...
        _getFloat64: function(a, b) {
            var c = this._getBytes(8, a, b),
                ...
                f = (15 & c[6]) * g(48) + c[5] * g(40) + c[4] * g(32) + c[3] * g(24) + c[2] * g(16) + c[1] * g(8) + c[0];
