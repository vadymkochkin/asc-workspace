...
class ProfilesController extends Controller
{
    ...
    public function show($username)
    {
        ...
        return view('ucp.pages.profile.show')->with($data);
    }
    ...
    public function edit($username)
    {
        ...
        return view('ucp.pages.profile.edit')->with($data);
    }
    ...
    public function change_password($username)
    {
        ...
        return view('ucp.pages.profile.change_password')->with($data);
    }
    ...
    public function delete_account($username)
    {
        ...
        return view('ucp.pages.profile.delete_account')->with($data);
    }
    ...
    public function updateUserPassword(UpdateUserPasswordRequest $request, $id)
    {
        ...
        return redirect('profile/'.$user->username.'/change-password')->with('success', trans('profile.updatePWSuccess'));
    }
    ...
    public function deleteUserAccount(DeleteUserAccount $request, $id)
    {
        ...
        if ($user->id != $currentUser->id) {
            return redirect('profile/'.$user->username.'/delete-account')->with('error', trans('profile.errorDeleteNotYour'));
        }
